...
from .forms import ReaderCreationForm, ReaderLogInForm
...
def activate_email(request, user, to_email):
    ...
    # if email.send():
    messages.success(request, f'Dear <b>{to_email.split("@")[0]}</b, please go to your email <b>{to_email}'
                              f'</b> inbox and verify your account.'
